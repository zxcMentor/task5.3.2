...
func (c *CourierController) Websocket(ctx *gin.Context, dz CourierMove) {
	...
	handleConnection(conn, func(msg webSocketMessage) {
		c.MoveCourier(msg, dz.Direction, dz.Zoom) // Замените 0, 0 на реальные значения direction и zoom
	})
}
